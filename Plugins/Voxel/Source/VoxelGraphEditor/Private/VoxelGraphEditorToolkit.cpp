...
{
	FVoxelDebugGraphUtils::DebugNodes(Nodes, Generator);
	VoxelDebugGraphEditor->ZoomToFit(false);
}
...
void FVoxelGraphEditorToolkit::SaveAsset_Execute()
{
	...
	{
		FVoxelGraphCompileToCpp::Compile(Generator, true);
	}
...
{
	FVoxelGraphCompileToCpp::Compile(Generator, false);
}
...
void FVoxelGraphEditorToolkit::ShowAxisDependencies()
{
	...
	Generator->CreateGraphs(Graphs, false, false, true);
}
