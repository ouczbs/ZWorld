...
#include "AnimNode_MemberAdditiveBlend.generated.h"


// Layered blend (per bone); has dynamic number of blendposes that can blend per different bone sets
USTRUCT(BlueprintInternalUseOnly)
struct GAMEFRAME_API FAnimNode_MemberAdditiveBlend : public FAnimNode_LinkNodeBase
{
	GENERATED_USTRUCT_BODY()

public:
    UPROPERTY(EditAnywhere)
	FString Name = "AnimNode_MemberAdditiveBlend";
	/** The source pose */
